...
from gokil.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "gokil.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~gokil.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~gokil.handlers.MessageHandler` the *update* argument will be a :obj:`~gokil.types.Message`; in a :obj:`~gokil.handlers.CallbackQueryHandler` the *update* will be a :obj:`~gokil.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~gokil.filters.command` or :meth:`~gokil.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~gokil.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Document` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Game` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Video` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~gokil.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Location` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~gokil.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~gokil.types.Message`.
    ...
    async def func(flt, client: gokil.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~gokil.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~gokil.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~gokil.types.InlineQuery`: The filter will match ``query``.
