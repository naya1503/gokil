...
import gokil
from gokil import __version__, __license__
from gokil import enums
from gokil import raw
from gokil import utils
from gokil.crypto import aes
from gokil.errors import CDNFileHashMismatch
from gokil.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from gokil.handlers.handler import Handler
from gokil.methods import Methods
from gokil.session import Auth, Session
from gokil.storage import FileStorage, MemoryStorage
from gokil.types import User, TermsOfService
from gokil.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~gokil.Client.export_session_string` before stopping the client to get a session string you can
    ...
    APP_VERSION = f"Gokil {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Gokil (version {__version__})")
        print(f"Gokil is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~gokil.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.gokil.org/start/auth")
