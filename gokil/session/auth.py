...
from gokil.connection import Connection
from gokil.crypto import aes, rsa, prime
from gokil.errors import SecurityCheckMismatch
from gokil.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "gokil.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
