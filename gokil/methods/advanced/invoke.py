...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <gokil.api.functions>` package and may accept compound
        data types from :obj:`types <gokil.api.types>` as well as bare types such as ``int``, ``str``, etc...
