...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~gokil.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, gokil.Client):
                self.add_handler(gokil.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        gokil.handlers.ChatJoinRequestHandler(func, self),
