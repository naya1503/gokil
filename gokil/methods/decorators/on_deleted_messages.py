...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~gokil.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, gokil.Client):
                self.add_handler(gokil.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        gokil.handlers.DeletedMessagesHandler(func, self),
