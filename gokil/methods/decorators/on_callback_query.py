...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~gokil.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, gokil.Client):
                self.add_handler(gokil.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        gokil.handlers.CallbackQueryHandler(func, self),
