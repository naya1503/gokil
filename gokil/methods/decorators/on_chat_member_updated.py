...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~gokil.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, gokil.Client):
                self.add_handler(gokil.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        gokil.handlers.ChatMemberUpdatedHandler(func, self),
