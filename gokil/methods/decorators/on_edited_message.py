...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~gokil.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, gokil.Client):
                self.add_handler(gokil.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        gokil.handlers.EditedMessageHandler(func, self),
