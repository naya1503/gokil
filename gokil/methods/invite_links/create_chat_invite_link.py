...
class CreateChatInviteLink:
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~gokil.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~gokil.types.ChatInviteLink`: On success, the new invite link is returned.
