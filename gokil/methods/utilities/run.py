...
import gokil
from gokil.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~gokil.Client.start`, :meth:`~gokil.idle` and :meth:`~gokil.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`gokil.compose`.
