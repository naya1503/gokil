...
import gokil
from gokil import StopTransmission, enums
from gokil import raw
from gokil import types
from gokil import utils
from gokil.errors import FilePartMissing
from gokil.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~gokil.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~gokil.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~gokil.Client.stop_transmission`, None is returned.
