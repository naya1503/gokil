...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~gokil.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~gokil.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~gokil.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "gokil". Get the first 50 results
                async for message in app.search_global("gokil", limit=50):
                    print(message.text)
