...
from gokil.errors import AuthBytesInvalid
from gokil.session import Session
from gokil.session.auth import Auth


async def get_session(client: "gokil.Client", dc_id: int):
