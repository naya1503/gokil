...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~gokil.types.InputMediaPhoto`, :obj:`~gokil.types.InputMediaVideo`, :obj:`~gokil.types.InputMediaAudio` and :obj:`~gokil.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~gokil.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from gokil.types import InputMediaPhoto, InputMediaVideo
