...
class ResendCode:
    async def resend_code(
        ...
        :obj:`~gokil.types.SentCode` object returned by :meth:`send_code`.
        ...
        Returns:
            :obj:`~gokil.types.SentCode`: On success, an object containing information on the re-sent confirmation
            code is returned.
