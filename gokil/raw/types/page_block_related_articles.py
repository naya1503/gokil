...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <gokil.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <gokil.raw.base.PageRelatedArticle>`):
            N/A
