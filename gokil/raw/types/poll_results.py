...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <gokil.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <gokil.raw.base.MessageEntity>`, *optional*):
            N/A
