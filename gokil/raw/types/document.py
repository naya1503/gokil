...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <gokil.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <gokil.raw.base.VideoSize>`, *optional*):
            N/A
