...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <gokil.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <gokil.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <gokil.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <gokil.raw.base.updates.State>`):
            N/A
