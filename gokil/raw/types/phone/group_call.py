...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <gokil.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <gokil.raw.base.GroupCallParticipant>`):
            N/A
