...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <gokil.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <gokil.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <gokil.raw.base.PremiumSubscriptionOption>`):
            N/A
