...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <gokil.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <gokil.raw.base.auth.CodeType>`, *optional*):
            N/A
