...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <gokil.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <gokil.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <gokil.raw.base.SecureValueError>`):
            N/A
