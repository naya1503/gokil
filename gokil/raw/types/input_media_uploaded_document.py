...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <gokil.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <gokil.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <gokil.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <gokil.raw.base.InputDocument>`, *optional*):
            N/A
