...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <gokil.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <gokil.raw.base.MessagePeerReaction>`, *optional*):
            N/A
