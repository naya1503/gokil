...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <gokil.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <gokil.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <gokil.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <gokil.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <gokil.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <gokil.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <gokil.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <gokil.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <gokil.raw.base.StatsGroupTopInviter>`):
            N/A
