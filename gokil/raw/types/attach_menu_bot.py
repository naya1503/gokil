...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <gokil.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <gokil.raw.base.AttachMenuBotIcon>`):
            N/A
