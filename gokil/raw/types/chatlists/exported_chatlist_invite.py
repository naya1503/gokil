...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <gokil.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <gokil.raw.base.ExportedChatlistInvite>`):
            N/A
