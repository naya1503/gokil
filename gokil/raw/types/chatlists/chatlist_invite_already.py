...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <gokil.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <gokil.raw.base.Peer>`):
            N/A
