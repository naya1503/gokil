...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <gokil.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <gokil.raw.base.PhoneConnection>`):
            N/A
