...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <gokil.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <gokil.raw.base.ThemeSettings>`, *optional*):
            N/A
