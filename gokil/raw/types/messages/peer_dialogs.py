...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <gokil.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <gokil.raw.base.Message>`):
            N/A
