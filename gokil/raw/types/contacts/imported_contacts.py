...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <gokil.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <gokil.raw.base.PopularContact>`):
            N/A
