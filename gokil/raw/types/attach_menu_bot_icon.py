...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~gokil.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <gokil.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <gokil.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
