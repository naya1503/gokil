...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <gokil.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <gokil.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <gokil.raw.base.phone.GroupParticipants>`
    """
