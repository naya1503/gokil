...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <gokil.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <gokil.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <gokil.raw.base.messages.Messages>`
    """
