...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~gokil.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <gokil.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <gokil.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~gokil.raw.types`
    """
