...
class AcceptAuthorization(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        value_hashes (List of :obj:`SecureValueHash <gokil.raw.base.SecureValueHash>`):
            N/A

        credentials (:obj:`SecureCredentialsEncrypted <gokil.raw.base.SecureCredentialsEncrypted>`):
            N/A
