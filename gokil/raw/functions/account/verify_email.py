...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <gokil.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <gokil.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <gokil.raw.base.account.EmailVerified>`
    """
