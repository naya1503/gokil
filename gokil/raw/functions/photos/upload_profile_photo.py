...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <gokil.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <gokil.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <gokil.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <gokil.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <gokil.raw.base.photos.Photo>`
    """
