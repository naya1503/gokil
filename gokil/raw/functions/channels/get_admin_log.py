...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        channel (:obj:`InputChannel <gokil.raw.base.InputChannel>`):
            N/A
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <gokil.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <gokil.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <gokil.raw.base.channels.AdminLogResults>`
    """
