...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <gokil.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <gokil.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <gokil.raw.base.payments.ValidatedRequestedInfo>`
    """
