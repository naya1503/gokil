...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~gokil.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~gokil.Client.sign_in` or :meth:`~gokil.Client.sign_up`).

        next_type (:obj:`~gokil.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~gokil.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~gokil.Client.resend_code`.
    """
