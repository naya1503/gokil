...
from gokil import types, utils, enums
...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        action (:obj:`~gokil.enums.ChatEventAction`):
            Event action.

        user (:obj:`~gokil.types.User`):
            User that triggered the event.

        old_description, new_description (``str``, *optional*):
            Previous and new chat description.
            For :obj:`~gokil.enums.ChatEventAction.DESCRIPTION_CHANGED` action only.

        old_history_ttl, new_history_ttl (``int``, *optional*):
            Previous and new chat history TTL.
            For :obj:`~gokil.enums.ChatEventAction.HISTORY_TTL_CHANGED` action only.

        old_linked_chat, new_linked_chat (:obj:`~gokil.types.Chat`, *optional*):
            Previous and new linked chat.
            For :obj:`~gokil.enums.ChatEventAction.LINKED_CHAT_CHANGED` action only.

        old_photo, new_photo (:obj:`~gokil.types.Photo`, *optional*):
            Previous and new chat photo.
            For :obj:`~gokil.enums.ChatEventAction.PHOTO_CHANGED` action only.

        old_title, new_title (``str``, *optional*):
            Previous and new chat title.
            For :obj:`~gokil.enums.ChatEventAction.TITLE_CHANGED` action only.

        old_username, new_username (``str``, *optional*):
            Previous and new chat username.
            For :obj:`~gokil.enums.ChatEventAction.USERNAME_CHANGED` action only.

        old_chat_permissions, new_chat_permissions (:obj:`~gokil.types.ChatPermissions`, *optional*):
            Previous and new default chat permissions.
            For :obj:`~gokil.enums.ChatEventAction.CHAT_PERMISSIONS_CHANGED` action only.

        deleted_message (:obj:`~gokil.types.Message`, *optional*):
            Deleted message.
            For :obj:`~gokil.enums.ChatEventAction.MESSAGE_DELETED` action only.

        old_message, new_message (:obj:`~gokil.types.Message`, *optional*):
            Previous and new message before it has been edited.
            For :obj:`~gokil.enums.ChatEventAction.MESSAGE_EDITED` action only.

        invited_member (:obj:`~gokil.types.ChatMember`, *optional*):
            New invited chat member.
            For :obj:`~gokil.enums.ChatEventAction.MEMBER_INVITED` action only.

        old_administrator_privileges, new_administrator_privileges (:obj:`~gokil.types.ChatMember`, *optional*):
            Previous and new administrator privileges.
            For :obj:`~gokil.enums.ChatEventAction.ADMINISTRATOR_PRIVILEGES_CHANGED` action only.

        old_member_permissions, new_member_permissions (:obj:`~gokil.types.ChatMember`, *optional*):
            Previous and new member permissions.
            For :obj:`~gokil.enums.ChatEventAction.MEMBER_PERMISSIONS_CHANGED` action only.

        stopped_poll (:obj:`~gokil.types.Message`, *optional*):
            Message containing the stopped poll.
            For :obj:`~gokil.enums.ChatEventAction.POLL_STOPPED` action only.

        invites_enabled (``bool``, *optional*):
            If chat invites were enabled (True) or disabled (False).
            For :obj:`~gokil.enums.ChatEventAction.INVITES_ENABLED` action only.

        history_hidden (``bool``, *optional*):
            If chat history has been hidden (True) or unhidden (False).
            For :obj:`~gokil.enums.ChatEventAction.HISTORY_HIDDEN` action only.

        signatures_enabled (``bool``, *optional*):
            If message signatures were enabled (True) or disabled (False).
            For :obj:`~gokil.enums.ChatEventAction.SIGNATURES_ENABLED` action only.

        old_slow_mode, new_slow_mode (``int``, *optional*):
            Previous and new slow mode value in seconds.
            For :obj:`~gokil.enums.ChatEventAction.SLOW_MODE_CHANGED` action only.

        pinned_message (:obj:`~gokil.types.Message`, *optional*):
            Pinned message.
            For :obj:`~gokil.enums.ChatEventAction.MESSAGE_PINNED` action only.

        unpinned_message (:obj:`~gokil.types.Message`, *optional*):
            Unpinned message.
            For :obj:`~gokil.enums.ChatEventAction.MESSAGE_UNPINNED` action only.

        old_invite_link, new_invite_link (:obj:`~gokil.types.ChatInviteLink`, *optional*):
            Previous and new edited invite link.
            For :obj:`~gokil.enums.ChatEventAction.INVITE_LINK_EDITED` action only.

        revoked_invite_link (:obj:`~gokil.types.ChatInviteLink`, *optional*):
            Revoked invite link.
            For :obj:`~gokil.enums.ChatEventAction.INVITE_LINK_REVOKED` action only.

        deleted_invite_link (:obj:`~gokil.types.ChatInviteLink`, *optional*):
            Deleted invite link.
            For :obj:`~gokil.enums.ChatEventAction.INVITE_LINK_DELETED` action only.
    """
