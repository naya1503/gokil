...
class Object:
    def __init__(self, client: "gokil.Client" = None):
        self._client = client

    def bind(self, client: "gokil.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~gokil.types.Client`):
