...
TAG = v$(shell grep -E '__version__ = ".*"' gokil/__init__.py | cut -d\" -f2)
...
clean-api:
	$(RM) gokil/errors/exceptions gokil/raw/all.py gokil/raw/base gokil/raw/functions gokil/raw/types
